...
public class Run_Aes_Gcm_BC_Kat {
    public static void main(String[] args) throws IOException, NoSuchPaddingException, InvalidAlgorithmParameterException, NoSuchAlgorithmException, IllegalBlockSizeException, BadPaddingException, InvalidKeyException, NoSuchProviderException {
        TeePrintStream ts = new TeePrintStream(System.out, "AES-GCM_BC_KAT_Results.txt", true);
        System.setOut(ts);
        System.out.println("AES GCM BC Known Answer Test (KAT)");
        ...
        for (int algs = 0; algs < filenames.length; algs++) {
            ...
            for (int i = 0; i < counterSize; i++) {
                ...
                if (taglen < 1) {
                    // bouncy castle works even with smaller taglen
    ...
    public static byte[] aes_gcm_encrypt(byte[] plaintextByte, byte[] keyByte, byte[] initvectorByte, int taglen, byte[] aad) throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException, InvalidAlgorithmParameterException, BadPaddingException, IllegalBlockSizeException, NoSuchProviderException {
        byte[] ciphertextByte = null;
        SecretKeySpec keySpec = new SecretKeySpec(keyByte, "AES");
        GCMParameterSpec gcmParameterSpec = new GCMParameterSpec(taglen, initvectorByte);
        Cipher aesCipherEnc = Cipher.getInstance("AES/GCM/NOPADDING", "BC");
    ...
    public static byte[] aes_gcm_decrypt(byte[] ciphertextByte, byte[] keyByte, byte[] initvectorByte, int taglen, byte[] aad) throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException, InvalidAlgorithmParameterException, BadPaddingException, IllegalBlockSizeException, UnsupportedEncodingException, NoSuchProviderException {
        byte[] plaintextByte = null;
        SecretKeySpec keySpec = new SecretKeySpec(keyByte, "AES");
        GCMParameterSpec gcmParameterSpec = new GCMParameterSpec(taglen, initvectorByte);
        Cipher aesCipherDec = Cipher.getInstance("AES/GCM/NOPADDING", "BC");
