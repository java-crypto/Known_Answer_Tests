...
public class Run_Aes_Cbc_Kat {
    public static void main(String[] args) throws IOException, NoSuchPaddingException, InvalidAlgorithmParameterException, NoSuchAlgorithmException, IllegalBlockSizeException, BadPaddingException, InvalidKeyException {
        TeePrintStream ts = new TeePrintStream(System.out, "AES-CBC_KAT_Results.txt", true);
        System.setOut(ts);
        System.out.println("AES CBC Known Answer Test (KAT)");
        ...
        String[] filenames = { "kat/block_cipher/cbc/CBCVarKey128.rsp", "kat/block_cipher/cbc/CBCVarTxt128.rsp",
        "kat/block_cipher/cbc/CBCGFSbox128.rsp", "kat/block_cipher/cbc/CBCKeySbox128.rsp",
                "kat/block_cipher/cbc/CBCMMT128.rsp", "kat/block_cipher/cbc/CBCVarKey192.rsp",
                "kat/block_cipher/cbc/CBCVarTxt192.rsp", "kat/block_cipher/cbc/CBCGFSbox192.rsp",
                "kat/block_cipher/cbc/CBCKeySbox192.rsp", "kat/block_cipher/cbc/CBCMMT192.rsp",
                "kat/block_cipher/cbc/CBCVarKey256.rsp", "kat/block_cipher/cbc/CBCVarTxt256.rsp",
                "kat/block_cipher/cbc/CBCGFSbox256.rsp", "kat/block_cipher/cbc/CBCKeySbox256.rsp",
                "kat/block_cipher/cbc/CBCMMT256.rsp"};
        for (int algs = 0; algs < filenames.length; algs++) {
            ...
            for (int i = 0; i < counterSize; i++) {
                if (KAT_AES.modus.get(i) == "ENCRYPT") {
                    String ciphertextCalculated = bytesToHex(aes_cbc_encrypt(hexStringToByteArray(KAT_AES.plaintext.get(i)), hexStringToByteArray(KAT_AES.key.get(i)), hexStringToByteArray(KAT_AES.iv.get(i))));
                ...
                if (KAT_AES.modus.get(i) == "DECRYPT") {
                    String plainttextCalculated = bytesToHex(aes_cbc_decrypt(hexStringToByteArray(KAT_AES.ciphertext.get(i)), hexStringToByteArray(KAT_AES.key.get(i)), hexStringToByteArray(KAT_AES.iv.get(i))));
    ...
    public static byte[] aes_cbc_encrypt(byte[] plaintextByte, byte[] keyByte, byte[] initvectorByte) throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException, BadPaddingException, IllegalBlockSizeException {
    ...
    public static byte[] aes_cbc_decrypt(byte[] ciphertextByte, byte[] keyByte, byte[] initvectorByte) throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException {
