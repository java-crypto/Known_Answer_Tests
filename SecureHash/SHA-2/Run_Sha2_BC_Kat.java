...
public class Run_Sha2_BC_Kat {
    public static void main(String[] args) throws IOException {
        TeePrintStream ts = new TeePrintStream(System.out, "SHA2_BC_KAT_Results.txt", true);
        System.setOut(ts);
        ...
        for (int algs = 0; algs < digests.length; algs++) {
            ...
            for (int i = 0; i < counterSize; i++) {
                String mdCalculated = bytesToHex(sha_2_BC(hexStringToByteArray(KAT_SHA2.msg.get(i)), digests[algs]));
