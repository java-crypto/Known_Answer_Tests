...
public class Run_Sha2_Kat_MonteCarlo {
    public static void main(String[] args) throws IOException {
        TeePrintStream ts = new TeePrintStream(System.out, "SHA2_KAT_MonteCarlo_Results.txt", true);
        System.setOut(ts);
        ...
        for (int algs = 0; algs < digests.length; algs++) {
            ...
            for (int j = 0; j < counterSize; j++) {
                ...
                for (int i = 3; i < 1003; i++) {
                    ...
                    mdCalculated = bytesToHex(sha_2(hexStringToByteArray(mdCombined), digests[algs]));
