...
public class Run_Sha1_BC_Kat {
    public static void main(String[] args) throws IOException {
        TeePrintStream ts = new TeePrintStream(System.out, "SHA1_BC_KAT_Results.txt", true);
        System.setOut(ts);
        Security.addProvider(new BouncyCastleProvider());
        System.out.println("SHA-1 BC Known Answer Test (KAT)");
        ...
        String[] filenames = {"kat/sha_1/SHA1ShortMsg.rsp", "kat/sha_1/SHA1LongMsg.rsp"};
        for (int algs = 0; algs < filenames.length; algs++) {
            ...
            for (int i = 0; i < counterSize; i++) {
                String mdCalculated = bytesToHex(sha_1_BC(hexStringToByteArray(KAT_SHA1.msg.get(i))));
    ...
    public static byte[] sha_1_BC(byte[] input) {
