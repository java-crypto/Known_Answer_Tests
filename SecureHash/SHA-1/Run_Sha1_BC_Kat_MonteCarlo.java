...
public class Run_Sha1_BC_Kat_MonteCarlo {
    public static void main(String[] args) throws IOException {
        TeePrintStream ts = new TeePrintStream(System.out, "SHA1_BC_KAT_MonteCarlo_Results.txt", true);
        System.setOut(ts);
        Security.addProvider(new BouncyCastleProvider());
        System.out.println("SHA-1 BC Know Answer Test (KAT) MonteCarlo");
        ...
        for (int j = 0; j < counterSize; j++) {
            ...
            for (int i = 3; i < 1003; i++) {
                ...
                mdCalculated = bytesToHex(sha_1_BC(hexStringToByteArray(mdCombined)));
