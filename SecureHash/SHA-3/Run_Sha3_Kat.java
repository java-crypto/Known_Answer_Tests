...
public class Run_Sha3_Kat {
    public static void main(String[] args) throws IOException {
        TeePrintStream ts = new TeePrintStream(System.out, "SHA3_KAT_Results.txt", true);
        System.setOut(ts);
        System.out.println("SHA-3 Family Known Answer Test (KAT)");
        ...
        for (int algs = 0; algs < digests.length; algs++) {
            ...
            for (int i = 0; i < counterSize; i++) {
                String mdCalculated = bytesToHex(sha_2(hexStringToByteArray(KAT_SHA3.msg.get(i)), digests[algs]));
