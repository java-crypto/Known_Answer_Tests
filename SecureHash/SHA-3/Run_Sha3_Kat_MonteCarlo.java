...
public class Run_Sha3_Kat_MonteCarlo {
    public static void main(String[] args) throws IOException {
        TeePrintStream ts = new TeePrintStream(System.out, "SHA3_KAT_MonteCarlo_Results.txt", true);
        System.setOut(ts);
        ...
        for (int algs = 0; algs < digests.length; algs++) {
            ...
            for (int j = 0; j < counterSize; j++) {
                ...
                for (int i = 3; i < 1003; i++) {
                    // inner loop
                    mdCalculated = bytesToHex(sha_2(hexStringToByteArray(md), digests[algs]));
